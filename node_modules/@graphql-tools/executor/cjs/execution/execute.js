...
function executeField(exeContext, parentType, source, fieldNodes, path, asyncPayloadRecord) {
    ...
    try {
        ...
        const args = (0, utils_1.getArgumentValues)(fieldDef, fieldNodes[0], exeContext.variableValues.coerced);
...
function buildResolveInfo(exeContext, fieldDef, fieldNodes, parentType, path) {
    ...
    let asyncHelpers;
    const variableValues = graphql_1.versionInfo.major >= 17 ? exeContext.variableValues : exeContext.variableValues.coerced;
    return {
...
function getStreamValues(exeContext, fieldNodes, path) {
    ...
    const stream = (0, utils_1.getDirectiveValues)(utils_1.GraphQLStreamDirective, fieldNodes[0], exeContext.variableValues);
    if (!stream) {
        return;
    }
    if (stream.if === false) {
...
function executeSubscription(exeContext) {
    ...
    try {
        ...
        // Build a JS object of arguments from the field.arguments AST, using the
        // variables scope to fulfill any variable references.
        const args = (0, utils_1.getArgumentValues)(fieldDef, fieldNodes[0], variableValues.coerced);
        // The resolve function's optional third argument is a context value that
        // is provided to every resolve function within an execution. It is commonly
        // used to represent an authenticated user, or request-specific caches.
        const contextValue = exeContext.contextValue;
