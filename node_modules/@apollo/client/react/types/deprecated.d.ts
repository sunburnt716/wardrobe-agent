...
export type MutationHookOptions<TData = unknown, TVariables extends OperationVariables = OperationVariables, _TContext = DefaultContext, TCache extends Cache.Implementation = Cache.Implementation> = useMutation.Options<TData, TVariables, TCache>;
...
export type MutationFunctionOptions<TData = unknown, TVariables extends OperationVariables = OperationVariables, _TContext = DefaultContext, TCache extends Cache.Implementation = Cache.Implementation> = useMutation.MutationFunctionOptions<TData, TVariables, TCache>;
/** @deprecated Use `useMutation.ResultTuple` instead */
export type MutationTuple<TData, TVariables extends OperationVariables, _TContext = DefaultContext, TCache extends Cache.Implementation = Cache.Implementation> = useMutation.ResultTuple<TData, TVariables, TCache>;
