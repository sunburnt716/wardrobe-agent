...
class QueryManager {
    ...
    clearStore(options = {
        ...
        this.cancelPendingFetches((0, invariant_1.newInvariantError)(95));
        ...
        if (environment_1.__DEV__ && queryNamesAndQueryStrings.size) {
            queryNamesAndQueryStrings.forEach((included, nameOrQueryString) => {
                if (!included) {
                    ...
                    if (queryName) {
                        __DEV__ && invariant_1.invariant.warn(96, queryName);
                    }
                    else {
                        __DEV__ && invariant_1.invariant.warn(97);
                    }
                }
            });
        }
...
function validateDidEmitValue() {
    ...
    return (0, rxjs_2.tap)({
        ...
        complete() {
            (0, invariant_1.invariant)(didEmitValue, 104);
        },
    });
}
