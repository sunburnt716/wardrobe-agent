...
class ApolloClient {
    ...
    constructor(options) {
        if (environment_1.__DEV__) {
            (0, invariant_1.invariant)(options.cache, 70);
            (0, invariant_1.invariant)(options.link, 71);
        }
        ...
        if (environment_1.__DEV__) {
            ...
            if (refetchOn) {
                ...
                if (!refetchEventManager) {
                    __DEV__ && invariant_1.invariant.warn(72, operationName);
                }
                else if (typeof refetchOn === "object") {
                    Object.keys(refetchOn).forEach((source) => {
                        if (!refetchEventManager.hasSource(source)) {
                            __DEV__ && invariant_1.invariant.warn(73, source, operationName);
                        }
                    });
                }
            }
    ...
    */
    query = (options) => {
        ...
        if (environment_1.__DEV__) {
            (0, invariant_1.invariant)(options.fetchPolicy !== "cache-and-network", 74);
            (0, invariant_1.invariant)(options.fetchPolicy !== "standby", 75);
            (0, invariant_1.invariant)(options.query, 76);
            (0, invariant_1.invariant)(options.query.kind === "Document", 77);
            (0, invariant_1.invariant)(!options.returnPartialData, 78);
            (0, invariant_1.invariant)(!options.pollInterval, 79);
            (0, invariant_1.invariant)(!options.notifyOnNetworkStatusChange, 80);
        }
    ...
    */
    mutate = (options) => {
        ...
        if (environment_1.__DEV__) {
            (0, invariant_1.invariant)(optionsWithDefaults.mutation, 81);
    ...
    refetchQueries(options) {
        ...
        result.catch((error) => {
            __DEV__ && invariant_1.invariant.debug(83, error);
        });
        return result;
    }
    /**
