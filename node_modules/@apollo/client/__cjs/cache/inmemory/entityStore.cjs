...
class EntityStore {
    ...
    merge(older, newer) {
        ...
        if (!incoming)
            return;
        (0, invariant_1.invariant)(typeof dataId === "string", 108);
                            ...
                            if (environment_1.__DEV__) {
                                const checkReference = (ref) => {
                                    if (this.lookup(ref.__ref) === undefined) {
                                        __DEV__ && invariant_1.invariant.warn(109, ref);
                                        return true;
                                    }
                                };
                                if ((0, utilities_1.isReference)(newValue)) {
                                    ...
                                    for (const value of newValue) {
                                        ...
                                        if (seenReference && someNonReference !== undefined) {
                                            __DEV__ && invariant_1.invariant.warn(110, someNonReference);
                                            break;
                                        }
                                    }
                                }
    ...
    coerceValue(value, coerce, scalarType, coordinate) {
        ...
        if (scalarType) {
            const match = (0, internal_1.matchScalarList)(scalarType);
            if (match) {
                if (Array.isArray(value)) {
                    ...
                    if (environment_1.__DEV__) {
                        __DEV__ && invariant_1.invariant.warn(111, coordinate, scalarType, (0, internal_1.unwrapScalarType)(scalarType));
                    }
                }
            }
            const scalar = this.policies.cache.getScalar((0, internal_1.unwrapScalarType)(scalarType));
            if (scalar) {
        ...
        if ((0, internal_1.isPlainObject)(value) && "__typename" in value) {
