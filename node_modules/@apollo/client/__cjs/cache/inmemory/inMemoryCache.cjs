...
class InMemoryCache extends cache_js_1.ApolloCache {
    ...
    serializeVariables(document, variables) {
        ...
        const variableTypes = (0, internal_1.getOperationDefinition)(document)?.variableDefinitions?.reduce((memo, node) => {
            memo[node.variable.name.value] = (0, helpers_js_1.getScalarTypeFromTypeNode)(node.type);
            return memo;
        }, {});
        ...
        if (scalarType) {
            ...
            if (match) {
                if (Array.isArray(value)) {
                    ...
                    __DEV__ && invariant_1.invariant.warn(112, coordinate, scalarType, (0, internal_1.unwrapScalarType)(scalarType));
                }
            }
            const scalar = this.getScalar((0, internal_1.unwrapScalarType)(scalarType));
            if (scalar) {
    ...
    serializeInputObject(value, variableTypes, coordinate) {
        ...
        const entries = Object.entries(value).map(([name, value]) => {
            ...
            const inputObject = this.config.inputObjects?.[(0, internal_1.unwrapScalarType)(type)];
            if (inputObject) {
