...
import type { handleIncrementalSymbol, IsLooselyEqual } from "@apollo/client/utilities/internal";
import { getInMemoryCacheMemoryInternals } from "@apollo/client/utilities/internal";
import { ApolloCache } from "../core/cache.cjs";
import type { Scalar } from "../core/Scalar.cjs";
import type { Cache } from "../core/types/Cache.cjs";
import { Policies } from "./policies.cjs";
import { makeVar } from "./reactiveVars.cjs";
import type { DiffIncrementalInfo, InMemoryCacheConfig, KnownScalars, NormalizedCacheObject, ScalarType } from "./types.cjs";
