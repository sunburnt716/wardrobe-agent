...
class StoreWriter {
    ...
    writeToStore(store, { query, result, dataId, variables, overwrite, extensions, }) {
        ...
        if (!(0, utilities_1.isReference)(ref)) {
            throw (0, invariant_1.newInvariantError)(122, result);
        }
        ...
        context, typename).forEach((context, field) => {
            ...
            if (value !== void 0) {
                ...
                if (merge) {
                    ...
                    (0, internal_1.isStreamField)(field, context.variables)) {
                    childTree.info = {
                        field,
                        typename,
                ...
                invariant_1.invariant.error(123, (0, internal_1.resultKeyNameFromField)(field), result);
            }
        });
            ...
            selectionSet.selections.forEach((selection) => {
                ...
                if ((0, internal_1.isField)(selection)) {
                    ...
                    if (!fragment && selection.kind === graphql_1.Kind.FRAGMENT_SPREAD) {
                        throw (0, invariant_1.newInvariantError)(124, selection.name.value);
                    }
                    if (fragment &&
...
function warnAboutDataLoss(existingRef, incomingObj, storeFieldName, store) {
    ...
    __DEV__ && invariant_1.invariant.warn(125, fieldName, parentType, childTypenames.length ?
