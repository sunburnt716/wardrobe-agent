import type { DocumentNode, FragmentDefinitionNode, InlineFragmentNode, OperationTypeNode } from "graphql";
import { Observable } from "rxjs";
import type { DataValue, GetDataState, InternalTypes, OperationVariables, TypedDocumentNode, TypeOverrides } from "@apollo/client";
import type { Unmasked } from "@apollo/client/masking";
import type { Reference, StoreObject } from "@apollo/client/utilities";
import type { ApplyHKTImplementationWithDefault, handleIncrementalSymbol, IsAny, Prettify } from "@apollo/client/utilities/internal";
import { getApolloCacheMemoryInternals } from "@apollo/client/utilities/internal";
import type { DiffIncrementalInfo, ScalarType } from "../inmemory/types.cjs";
import type { Scalar } from "./Scalar.cjs";
...
export declare namespace ApolloCache {
     ...
     * ```
     */
    type FromOptionValue<TData> = ApplyHKTImplementationWithDefault<TypeOverrides, "FromOptionValue", InternalTypes.OverridableTypes.Defaults, TData>;
    /**
    ...
    type GetScalarType<TKey extends keyof ApolloCache.Scalars> = ApolloCache.Scalars[TKey] extends ({
...
export declare abstract class ApolloCache {
     ...
     * cache.
     */
    abstract diff<TData = unknown, TVariables extends OperationVariables = OperationVariables>(query: Cache.DiffOptions<TData, TVariables> & {
