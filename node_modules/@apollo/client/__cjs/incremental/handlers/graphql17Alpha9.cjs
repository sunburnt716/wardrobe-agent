...
class IncrementalRequest {
    ...
    _streamInfo = (0, internal_1.makeStreamInfoTrie)();
    ...
    handle(cacheData = this.data, chunk) {
        ...
        if (this._streamInfo["strong"]) {
            result.extensions = {
                ...
                // itself.
                [internal_1.streamInfoSymbol]: new WeakRef(this._streamInfo),
            };
        }
        return result;
    }
...
class GraphQL17Alpha9Handler {
    documentTransform = new utilities_1.DocumentTransform(internal_1.addDeferFragmentLabels);
    /**
    * @internal
    * 
    * @deprecated This is an internal API and should not be used directly. This can be removed or changed at any time.
