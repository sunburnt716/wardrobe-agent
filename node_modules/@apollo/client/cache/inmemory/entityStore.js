...
import { DeepMerger, isNonNullObject, isPlainObject, makeReference, matchScalarList, maybeDeepFreeze, unwrapScalarType, } from "@apollo/client/utilities/internal";
                            ...
                            if (__DEV__) {
                                const checkReference = (ref) => {
                                    if (this.lookup(ref.__ref) === undefined) {
                                        __DEV__ && invariant.warn(109, ref);
                                        return true;
                                    }
                                };
                                if (isReference(newValue)) {
                                    ...
                                    for (const value of newValue) {
                                        ...
                                        if (seenReference && someNonReference !== undefined) {
                                            __DEV__ && invariant.warn(110, someNonReference);
                                            break;
                                        }
                                    }
                                }
        ...
        if (scalarType) {
            ...
            if (match) {
                if (Array.isArray(value)) {
                    ...
                    if (__DEV__) {
                        __DEV__ && invariant.warn(111, coordinate, scalarType, unwrapScalarType(scalarType));
                    }
                }
            }
