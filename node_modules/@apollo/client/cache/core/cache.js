...
import { bindCacheKey, capitalize, combineLatestBatched, equalByQuery, getApolloCacheMemoryInternals, getFragmentDefinition, getFragmentQueryDocument, mapObservableFragmentMemoized, } from "@apollo/client/utilities/internal";
    ...
    watchFragment(options) {
        ...
        const ids = fromArray.map((value) => {
            ...
            if (__DEV__) {
                ...
                if (id === undefined) {
                    __DEV__ && invariant.warn(126, actualFragmentName);
                }
            }
            return id;
        });
